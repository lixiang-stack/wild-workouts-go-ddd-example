...
const file_users_proto_rawDesc = "" +
	...
	"\x15UpdateTrainingBalance\x12#.users.UpdateTrainingBalanceRequest\x1a\x14.users.EmptyResponse\"\x00BVZTgithub.com/ThreeDotsLabs/wild-workouts-go-ddd-example/internal/common/genproto/usersb\x06proto3"
